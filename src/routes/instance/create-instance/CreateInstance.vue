  ...
  <InstanceContent>
    ...
    <section class="flex flex-col items-center justify-center gap-6 mx-auto w-1/2 h-full">
      <div class="flex flex-col gap-2">
        ...
        <button type="submit" class="primary justify-between" @click="$router.push('/modpacks/curse')">
          <span>Browse Curse modpack</span>
          <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
          </svg>
        </button>
        <button type="submit" class="primary justify-between" @click="$router.push('/modpacks/feedthebeast')">
          <span>Browse Feed The Beast modpack</span>
          <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
          </svg>
        </button>
