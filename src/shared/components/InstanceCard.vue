  ...
  <div class="relative items-center inline-flex p-4 border rounded-lg shadow-md border-gray-700 hover:bg-gray-700">
    <div class="space-y-2 flex-grow" v-if="!isLoading">
      ...
      <span class="inline-grid grid-cols-3 items-center gap-2">
        <span class="text-sm font-medium p-2 rounded bg-green-900 text-green-300 inline-flex items-center h-full" v-if="instance?.versions?.minecraft">
        ...
        <span class="text-sm font-medium p-2 rounded bg-gray-900 text-gray-300 inline-flex items-center h-full" v-if="instance?.versions?.forge">
          <img src="../../assets/forge_logo.ico" class="w-4 h-4 mr-1.5" alt="Forge logo" />
          <span class="text-white font-medium text-xs">{{ instance?.versions?.forge.name }}</span>
        </span>
        <span class="text-sm font-medium p-2 rounded bg-orange-900 text-orange-300 inline-flex items-center h-full" v-if="instance?.versions?.fabric">
        ...
        <span class="text-sm font-medium p-2 rounded bg-orange-900 text-orange-300 inline-flex items-center h-full" v-if="instance?.versions?.quilt">
